...
| [Day 2](day-2/README.md) | RAG & Embeddings | Property amenity finder | Embeddings, vector store, chunking, retrieval |
| Day 3 *(coming)* | Agents & Tool Use | — | Function calling, tool loops, orchestration |
...
Day 2 — Embeddings & RAG
  ...
  Same accuracy as stuffing all data in, at a fraction of the token cost.
        ↓
Day 3 — Agents & Tool Use  (coming)
  The model decides what to do next. Tools extend what it can reach.
  Loops, retries, and orchestration.
```
